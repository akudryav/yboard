 ...
 <div id="topheader">
   ...
   <div class="menu_area">
		<div class='ideas'>
			...
			<a href='<?php echo Yii::app()->createUrl("/adverts/create")?>' class="menu_text"><i class='fa fa-plus'></i>добавить</a>
		</div>
	    <div class='links'>
			<a href="<?php echo Yii::app()->createUrl("/user")?>" class="general">Пользователи</a>
	    </div>
	    <div class='info'>
			<a href="<?php echo Yii::app()->createUrl("/site/page")?>" class="general">Правила работы</a> 
	    </div>
	    <div class="works">
			<a href="<?php echo Yii::app()->createUrl("/site/contacts")?>" class="general">Контакты</a>
		</div>
   </div>
 </div>
</div>
