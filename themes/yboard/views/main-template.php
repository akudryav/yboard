...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script> baseUrl = '<?php echo  Yii::app()->baseUrl ?>';</script>
        ...
        <div id='content'>
            <div id="body_area">
                <div class="left">
                    ...
                    <?php echo  $this->getBanner('right_adv') ?>
                ...
                <div class="midarea">
                    <form name='search_form' class='searchForm' action='<?php echo  Yii::app()->createUrl('/adverts/search') ?>'>
                        <input type='text' name='searchStr'  
                               value='<?php echo  Yii::app()->request->getParam("searchStr") ?>' />
                        <input type='submit' value='Поиск' class='btn' /> <br/>
                        <a href="javascript:void(0)" onclick="open_search()" ><?php echo  t("Advanced search") ?></a>
